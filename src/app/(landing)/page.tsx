            ...
            <ul className="space-y-2 text-base/7 text-gray-600 text-left flex flex-col items-start">
              {[
                ...
                <li key={index} className="flex gap-1.5 items-center text-left">
                  <Icons.check className="size-5 shrink-0 text-brand-700" />
                  {item}
                </li>
              ))}
            </ul>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg) + 1)] lg:rounded-l-[calc(2rem + 1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
                    Real-time notifications
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Get notified critical events the moment they happen, no
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              <div className="flex gap-0.5 mb-2 justify-center lg:justify-start">
                <Icons.star className="size-5 text-brand-600 fill-brand-600" />
                <Icons.star className="size-5 text-brand-600 fill-brand-600" />
                <Icons.star className="size-5 text-brand-600 fill-brand-600" />
                <Icons.star className="size-5 text-brand-600 fill-brand-600" />
                <Icons.star className="size-5 text-brand-600 fill-brand-600" />
